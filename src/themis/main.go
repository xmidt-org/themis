	...
	var (
		...
		app = fx.New(
			...
			fx.Provide(
				...
				xhttpserver.Required("servers.key"),
				xhttpserver.Required("servers.issuer"),
				xhttpserver.Required("servers.claims"),
				xhttpserver.Optional("servers.metrics"),
				xhttpserver.Optional("servers.health"),
			),
			fx.Invoke(
				BuildKeyRoutes,
				BuildIssuerRoutes,
