...
type Reporter interface {
	...
	Report(*xmetrics.Labels, float64)
}

type ReporterFunc func(*xmetrics.Labels, float64)

func (rf ReporterFunc) Report(l *xmetrics.Labels, value float64) {
	rf(l, value)
}

type DiscardReporter struct{}

func (dr DiscardReporter) Report(*xmetrics.Labels, float64) {
}
...
func NewCounterReporter(c metrics.Counter) AdderReporter {
	return ReporterFunc(func(l *xmetrics.Labels, delta float64) {
...
func NewHistogramReporter(h metrics.Histogram) ObserverReporter {
	return ReporterFunc(func(l *xmetrics.Labels, value float64) {
